...
var layout = document.getElementById('layout').getContext('2d');

/** MAKE PARAMS OBJECT **/

var dunWid = 80; //size in cells of the floor.
var dunHei = 80;
var cellSize = 15;
var density = 40; // ammount of attempts at filling the floor.
var fullSizeW = dunWid * cellSize; //size in pixels of the floor.
var fullSizeH = dunHei * cellSize;
...
function prepwork() {
    ...
    var listVer = document.querySelector('#ver');
    var x = document.createElement('STYLE');
    var t = document.createTextNode('.counter li {width: ' + cellSize + 'px; height: ' + cellSize + 'px;}');
